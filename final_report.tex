...
\begin{itemize}[noitemsep]
    \item Full evaluation notebook with all 17 experiments and 19 model implementations
    \item Historical 4-hour OHLCV data for BTC, ETH, SOL, XRP, and DOGE (Nov 2021--Nov 2025)
    \item Pre-trained model artifacts and evaluation results
    \item All visualization code and generated figures
\end{itemize}

\noindent\textbf{Repository:} \url{https://github.com/HowardLiYH/crypto-regime-ml}
